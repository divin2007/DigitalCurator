      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="flex flex-col md:flex-row gap-8 bg-surface-container-lowest p-8 editorial-shadow group relative border border-outline-variant/10">
          ...
          <div className="w-full md:w-1/3 aspect-video md:aspect-square overflow-hidden z-10 pointer-events-none">
            <img alt="Bought Property" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBazJI622wRiagsGt7w3oUBGO54vXJs2hicyBOrZtCjL9YbsagKm7SWwZpx9CDcLV10Vpz1pI1r4eRb2JX9fbosk9jGacWEMielPtRtz9SiwdTmqyThnYHlUne01sH-7sVbWXSVUtyv0pDFUp6kBAxmBMxmNFgEtpl_oFAzhj1C2oa5JcbwE_YrrY2jDYTGURg5PYjYZ_xXtgd-XE1oYs6g8YEeBNxw6n7lIfTZzu-Xcduoo7FttHU3RwQpHBDJln8DM7ISKHL2-CQ" />
          </div>
