  ...
  return (
    <section className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="flex flex-col md:flex-row gap-8 bg-zinc-900 text-white p-8 editorial-shadow group relative">
          <Link href="/account/management" className="absolute inset-0 z-0" aria-label="Manage Serenity Peak Estate" />
          <div className="w-full md:w-1/3 aspect-video md:aspect-square overflow-hidden z-10 pointer-events-none">
          ...
          <div className="flex-1 flex flex-col justify-center z-10">
            ...
            <div className="flex flex-wrap gap-4">
              <Button href="/account/management" variant="primary" className="!bg-white !text-black hover:!bg-primary hover:!text-white flex items-center gap-2 relative z-20">
                <span className="material-symbols-outlined text-base">dashboard_customize</span> Management Console
              </Button>
              <Button href="/account/vault" variant="outline" className="!border-white/20 !text-[0.6875rem] relative z-20">Digital Deed</Button>
            </div>
          </div>
        </div>
      </div>
